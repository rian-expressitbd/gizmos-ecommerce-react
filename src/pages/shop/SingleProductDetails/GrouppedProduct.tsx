...
export default function GrouppedProductDetails() {
      ...
      <div className="w-full lg:w-[670px] ">
        ...
        <div className="flex gap-3 items-center mt-[50px]">
          ...
          <div className="w-full flex justify-between items-center border rounded-lg p-6">
            <Link to="/">USB Cable P-501 Printer/Laptop</Link>
            <h4 className="text-sm font-bold">$45</h4>
          </div>
        </div>
        ...
        <Button
          className="bg-[#2453D4] hover:bg-[#2453D4] px-4 py-2 flex gap-2 mt-[30px] items-center h-[66px]"
          title="addToCartBtn"
        >
