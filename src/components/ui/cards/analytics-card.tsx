      ...
      >
        ...
        <div className="absolute inset-y-0 self-center -right-2">
          <motion.div
            ...
            className="bg-blue-100 dark:bg-blue-900/80 rounded-full w-16 h-16 flex items-center justify-center p-2"
          >
            <Icon className="w-full h-full p-2 text-primary dark:text-blue-200" />
          </motion.div>
        </div>
