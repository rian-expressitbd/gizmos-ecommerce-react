...
export const Filter = ({ filterFields, onFilter }: FilterProps) => {
  ...
  return (
    <div className='relative'>
      ...
      {isOpen && (
        <div className='absolute left-0 mt-2 w-64 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg shadow-lg z-10 p-4'>
            ...
            <div key={field.key} className='mb-4'>
              ...
              {field.type === "checkbox" || field.type === "radio" ? (
                ...
                <select
                  ...
                  className='w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary text-sm text-gray-700 dark:text-gray-300 dark:bg-gray-700'
                >
