        ...
        <div className='flex items-center gap-2'>
          ...
          <button
            ...
            className={twMerge(
              ...
              checked ? (error ? "bg-red-600" : "bg-blue-600") : "bg-gray-200 dark:bg-gray-600",
              disabled || loading
                ? "cursor-not-allowed opacity-70"
                : "cursor-pointer focus:outline-none focus:ring-2 focus:ring-offset-2",
              error ? "focus:ring-red-200 dark:focus:ring-red-800" : "focus:ring-blue-200 dark:focus:ring-blue-800",
              loading && "opacity-80"
            )}
          >
            <span
