    ...
    >
      ...
      <button
        ...
        className={twMerge(
          ...
          checked ? "border border-blue-500" : "border  border-gray-400 dark:bg-gray-600",
          disabled
      ...
      >
        <span
          className={twMerge(
            ...
            checked ? "translate-x-[15px] bg-blue-400 " : "translate-x-[1px]  bg-gray-400 "
          )}
        />
      </button>
      ...
      {label && (
        <label
          htmlFor={id}
          className={twMerge(
            "text-sm  font-medium text-gray-600 dark:text-gray-300  select-none",
