  ...
  return (
    <div>
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 py-14">
        ...
        <div className="relative input-div w-[400px]">
          <input
            className="bg-transparent p-3 border-gray-400 border-[0.5px] w-full rounded-[5px]"
            placeholder="Your Email Address:"
            type="text"
            name=""
            id=""
          />
          <FaRegEnvelope size={24} className="right-[9px] top-[12px] absolute text-white" />
        </div>
