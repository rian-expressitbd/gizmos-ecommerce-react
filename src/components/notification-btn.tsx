...
const dotColors = ["bg-blue-500", "bg-green-500", "bg-purple-500", "bg-yellow-500", "bg-pink-500"];
    ...
    <Dropdown align='right' className='relative'>
      ...
      <DropdownContent className='w-fit sm:w-72 rounded-lg shadow-lg bg-white dark:bg-gray-700 fixed sm:absolute left-2 sm:left-auto right-2 sm:right-0 mt-2'>
        {/* <div className='flex items-center justify-between p-4 border-b border-gray-200 dark:border-gray-700'>
          ...
          <Link
            to={'/notifications'}
            className='text-blue-500 hover:text-blue-600 dark:text-blue-400 dark:hover:text-blue-300 hover:underline text-nowrap'
          >
            View All
          </Link>
        </div>
            ...
            <div className='divide-y divide-gray-100 dark:divide-gray-700 max-h-96 overflow-y-auto'>
              ...
              <a href='#' className='flex px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-700 relative'>
                <div className='shrink-0'>
                  <img className='rounded-full w-11 h-11' src='https://via.placeholder.com/150' alt='Profile' />
                ...
                <div className='w-full ps-3'>
                  ...
                  <div className='text-xs text-blue-600 dark:text-blue-500'>2 minutes ago</div>
                </div>
              </a>
