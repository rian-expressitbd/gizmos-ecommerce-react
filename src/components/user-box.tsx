      ...
      <Dropdown align="right">
        <DropdownTrigger>
          <div className="flex items-center space-x-2 cursor-pointer">
            <div className="relative p-2 rounded-full bg-gray-200 hover:bg-gray-100 dark:bg-gray-700 dark:hover:bg-gray-500 cursor-pointer transition-colors text-primary">
        ...
        <DropdownContent className="w-36 bg-white dark:bg-gray-700">
